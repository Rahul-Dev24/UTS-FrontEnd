    ...
    <>
      ...
      <div className="ticketBody">
        ...
        <div className="second">
          ...
          >
            <h5 style={{ marginLeft: "1.5rem" }}>गुम्मिडिपुण्डी</h5>
            <div
              style={{
                width: "50%",
                display: "flex",
            ...
            <h5 style={{ marginLeft: "1.5rem" }}>கும்மிடிபூண்டி</h5>
          </div>
          <div
            style={{
              display: "flex",
          ...
          >
            <h5 style={{ marginLeft: "1.5rem" }}>गिंडी</h5>
            <div
              style={{
                width: "50%",
                display: "flex",
            ...
            <h5 style={{ marginLeft: "1.5rem" }}>கிண்டி</h5>
          </div>
          <div
            style={{
              display: "flex",
        ...
        >
          ...
          <div style={{ display: "flex" }}>
            ...
            <h5 style={{ fontWeight: "100", color: "#000", fontSize: "0.7rem" }} >63 km</h5>
          </div>
        </div>
