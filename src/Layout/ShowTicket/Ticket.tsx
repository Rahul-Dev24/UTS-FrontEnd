...
const Ticket = () => {
  const [nextTrain, setNextTrain] = useState(false);
  return (
    <>
      <ProgressBar
      ...
      <Card sx={{ p: 1, boxShadow: 4, width: "105%" }}>
        <div className="ticket">
          <div className="ticketTop">
            ...
            >
              FARE: &nbsp; <img src="/rs_uts.png" width={15} height={15} /> 270.00
            </div>
          </div>
          <div className="ticketBottom">
            ...
            >
              ...
              >
                ...
                <h5 style={{ fontWeight: "500" }}>GUINDY</h5>
              </div>
            </div>
          </div>
