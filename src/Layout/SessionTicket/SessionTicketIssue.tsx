...
import { Typography, Box, TextField, Button, Radio, RadioGroup, FormControlLabel, FormControl, Card, Autocomplete } from '@mui/material';
                                    ...
                                    <TextField
                                        ...
                                        sx={{
                                            '& .MuiInput-underline:before': {
                                                borderBottomColor: '#ff6f00', // Underline color before focus
                                            },
                                            '& .MuiInput-underline:after': {
                                                borderBottomColor: '#ff6f00', // Underline color after focus
                                            },
                                        }}
                                    />
                                )}
